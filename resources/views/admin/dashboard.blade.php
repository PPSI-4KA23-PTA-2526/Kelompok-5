                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="btn-group w-100" role="group">
                            <button type="button" class="btn btn-outline-primary quick-filter" data-days="0">Hari Ini</button>
                            <button type="button" class="btn btn-outline-primary quick-filter" data-days="7">7 Hari</button>
                            <button type="button" class="btn btn-outline-primary quick-filter" data-days="30">30 Hari</button>
                        </div>
                    </div>
        ...
        <div class="card border-0 shadow-sm mb-3">
            <div class="card-body">
                ...
                <small class="text-muted">
                    ...
                    {{ $stats['revenue_growth'] ?? '0' }}% dari kemarin
                </small>
